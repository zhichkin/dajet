...
Нюанс: если отказаться только от одного плана обмена и перевести его на регистры сведений, то оставшийся второй план обмена всё-равно может быть источником проблем. Дело в том, что регистрация изменений объекта "Заказ клиента" в регистр сведений и в оставшийся план обмена выполняется в одной и той же транзакции!
