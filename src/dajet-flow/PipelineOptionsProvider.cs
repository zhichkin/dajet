...
{
    public sealed class PipelineOptionsProvider
    {
        ...
        public PipelineOptions Select(string name)
        {
            PipelineOptions options = null;
        ...
        public bool Insert(PipelineOptions entity)
        {
            int result;
            ...
            using (SqliteConnection connection = new(_connectionString))
            {
                ...
                using (SqliteCommand command = connection.CreateCommand())
                {
                    ...
                    foreach (PipelineBlock block in entity.Blocks)
                    {
                        ...
                        command.Parameters.AddWithValue("ordinal", block.Ordinal);
        ...
        public bool Update(PipelineOptions entity)
        {
            int result;
        ...
        public bool Delete(PipelineOptions entity)
        {
            int result;
