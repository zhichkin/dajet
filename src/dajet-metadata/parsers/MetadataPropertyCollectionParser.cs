    ...
    public sealed class MetadataPropertyCollectionParser
    {
        ...
        private void MetadataPropertyConverter(in ConfigFileReader source, in CancelEventArgs args)
        {
            ...
            if (source.Token == TokenType.StartObject)
            {
                ...
                // Свойство объекта:
                // -----------------
                // [6][2] 0.1.1.1.8 - флаг заимствования объекта из основной конфигурации ??? 0 если заимствование отстутствует
                ...
                //TODO: extensions support (!)
                // Свойство табличной части (значения 0.1.1.1.7 и 0.1.1.1.9 почему-то меняются местами...):
                // ----------------------------------------------------------------------------------------
                // [5][2] 0.1.1.1.8 - флаг заимствования объекта из основной конфигурации ??? 0 если заимствование отстутствует
