...
{
    public sealed class SqliteRequestProcessor : IProcessor
    {
        ...
        public SqliteRequestProcessor(in ScriptScope scope)
        {
        ...
        private void ProcessRecord(in SqliteDataReader reader)
        {
        ...
        private void ConfigureQueryParameters(in SqliteCommand command)
        {
        ...
        {
            using (SqliteConnection connection = _factory.Create(in _uri) as SqliteConnection)
            {
                connection.Open();
