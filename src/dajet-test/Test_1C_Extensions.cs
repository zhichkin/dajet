...
namespace DaJet.Metadata.Test
{
    [TestClass] public class Test_1C_Extensions
    {
        ...
        [TestMethod] public void WriteSchemaStorageToFile()
        {
        ...
        [TestMethod] public void ComputeHashFromString()
        {
            string input = "_а7";
        ...
        [TestMethod] public void ComputeHashFromHex()
        {
        ...
        [TestMethod] public void WriteExtensionZippedInfoToFile()
        {
        ...
        [TestMethod] public void DumpParamsFile()
        {
        ...
        [TestMethod] public void Extension_Root()
        {
